...
import { useFarm, Animal, HealthRecord, Treatment, WeightRecord, BreedingRecord, AnimalNote, DEFAULT_ANIMAL_PHOTO, SPECIES_OPTIONS } from "@/context/FarmContext";
      ...
      <html>
        <head>
          ...
          <style>
            ...
            .header { display: flex; items-center; justify-content: space-between; border-bottom: 2px solid #047857; padding-bottom: 10px; }
        ...
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-end sm:items-center justify-center p-4">
          ...
          >
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-bold text-<dyad-write path="src/pages/AnimalProfilePage.tsx" description="Completing AnimalProfilePage with full modal forms and expanded species handling">
"use client";
