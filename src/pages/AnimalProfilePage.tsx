                ...
                {animal.sex === "Female" && gestationCountdown && (
                  <div className="bg-gradient-to-r from-rose-500 via-pink-600 to-rose-600 text-white rounded-3xl p-5 shadow-lg relative overflow-hidden space-y-3">
                    ...
                    <div className="grid grid-cols-3 gap-2 text-center pt-1">
                      ...
                      <div className="bg-white<dyad-write path="src/pages/AnimalProfilePage.tsx" description="Completing AnimalProfilePage.tsx with lineage mother and father linking, female pregnancy countdown, and editable DOB/dates">
"use client";
