...
export const Dashboard: React.FC = () => {
  ...
  // Ownership breakdown
  const farmOwnedCount = activeAnimals.filter(a => (a.ownershipType || "Farm Owned") === "Farm Owned").length;
  const clientOwnedCount = activeAnimals.filter(a => a.ownershipType === "Client Owned").length;
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        >
          ...
          <p className="text-[10px] text-emerald-800/80 font-semibold mt-0.5">
            Farm-owned: {farmOwnedCount} · Client/partner: {clientOwnedCount}
          </p>
        </div>
      ...
      <div className="bg-white rounded-3xl p-5 border border-slate-100 shadow-sm space-y-4">
        <h3 className="font-bold text-slate-900 text-sm flex items<dyad-write path="src/pages/Dashboard.tsx" description="Writing complete Dashboard component with active livestock ownership breakdown.">
"use client";
