...
export const SettingsFarmProfile: React.FC = () => {
  ...
  // If no image, show custom preview fallback Unsplash agricultural farmland
  const farmHeaderPreview = formState.image || "https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&auto=format&fit=crop&q=80";
